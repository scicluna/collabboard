...
export default function Pin({ pin, currentPinPos, handlePinDragStart, handlePinDragMove, handlePinDragEnd, pinKeyDown }: PinProps) {
    const [focus, setFocus] = useState(false)
    return (
        <div
            key={pin._id}
            style={{ top: `${pin.y}px`, left: `${pin.x}px` }}
            className={`absolute pin h-12 w-8 flex justify-center items-center  
