...
export default function DashNav() {
    return (
        <nav className="h-[5dvh] w-full bg-slate-300 bg-opacity-60 flex items-center justify-between sm:p-10 p-5 shadow-md shadow-slate-700">
            ...
            <div className="w-1/3 flex justify-start h-full items-center">
                ...
                <span className="font-mono font-extrabold">COLLAB BOARD</span>
            </div>
